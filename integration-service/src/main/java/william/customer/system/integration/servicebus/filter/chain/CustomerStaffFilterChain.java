package william.customer.system.integration.servicebus.filter.chain;
...
public class CustomerStaffFilterChain {
     ...
     */
    public Collection<CustomerStaffDTO> doFilter(Collection<CustomerStaffDTO> customerStaffs) {
