package william.customer.system.integration.servicebus.router;

import william.customer.system.sdk.constants.OutsourcingSystemCode;
import william.customer.system.integration.servicebus.router.hangzhou.HangzhouOutsourcingCustomerSystemRouter;
